...
@interface LL2048DefaultTheme : NSObject <LL2048Theme>
@end

@implementation LL2048DefaultTheme
...
@interface LL2048VibrantTheme : NSObject <LL2048Theme>
@end

@implementation LL2048VibrantTheme
...
@interface LL2048JoyfulTheme : NSObject <LL2048Theme>
@end

@implementation LL2048JoyfulTheme
...
@implementation LL2048Theme

+ (Class)themeClassForType:(NSInteger)type
{
  switch (type) {
    case 1:
      return [LL2048VibrantTheme class];
    case 2:
      return [LL2048JoyfulTheme class];
    default:
      return [LL2048DefaultTheme class];
  }
}
